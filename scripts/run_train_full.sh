...
if [[ -z "${MODEL_PATH}" ]]; then
  if [[ -d "${HOME}/models/Qwen/Qwen3-4B-Instruct" ]]; then
    MODEL_PATH="${HOME}/models/Qwen/Qwen3-4B-Instruct"
  elif [[ -d "${HOME}/models/Qwen/Qwen3___4B-Instruct" ]]; then
    MODEL_PATH="${HOME}/models/Qwen/Qwen3___4B-Instruct"
    ...
    echo "  export MODEL_PATH=${HOME}/models/Qwen/Qwen3-4B-Instruct"
